...
public abstract class Voin extends Character implements CharacterInterface {
  public Voin(Names name, int hp, int maxHp, int damage, int defense, int initiative, int row, int col) {
